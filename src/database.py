...
class CoordinatesDatabase:
    ...
    def initialize_schema(self) -> bool:
        ...
        schema_statements = [
            ...
            CREATE TABLE IF NOT EXISTS recommended_channels (
                ...
                discovery_method TEXT DEFAULT 'forward',
                telegram_recommendation_count INTEGER DEFAULT 0,
                telegram_rec_source_density REAL DEFAULT 0.0,
    ...
    def add_recommended_channel(self, channel_id: int, data: Dict[str, Any]) -> bool:
        allowed = {
            ...
            "discovery_method",
            "telegram_recommendation_count",
            "telegram_rec_source_density",
            "last_harvest_date",
            "user_status",
            "user_notes",
